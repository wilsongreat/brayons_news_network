...
class NewsServices extends ChangeNotifier {
  ...
  String? _searchVal;
  List<SearchModel> _news = [];
  List<SearchModel> newslist = [];

  List<SearchModel> get news => _news;
  ...
  Future<SearchModel> newsSearch(String query) async {
    final url =
    ...
    if (response.statusCode == 200) {
      ...
      // print(responseList[0]['title']);
      _news.add(responseData);

      print('Expecting news');
      print(responseData.data!.sId);
      return responseData;
    } else {
